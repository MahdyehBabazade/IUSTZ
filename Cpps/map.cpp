...
Map::Map(int floor , string Boss , vector<int> path1 , vector<int> path2 , vector<int> path3 , vector<int> path4 ,
...
int Map :: getFloor(){return Floor;}

string Map :: getBoss(){return BOSS;}
